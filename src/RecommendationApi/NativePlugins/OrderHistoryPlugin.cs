...
namespace RecommendationApi.Plugins
{
    public class OrderHistoryPlugin
    {
        ...
        public async Task<string> OrderHistoryLookup([Description("The string username of the user. There should be no curly braces around the username.")] string username)
        {
