...
namespace RecommendationApi.Plugins
{
    public class LocationLookupPlugin
    {
        ...
        public async Task<string> LocationLookup([Description("The string location to lookup GPS coordinates for. This should be a string, not JSON.")] string location)
        {
